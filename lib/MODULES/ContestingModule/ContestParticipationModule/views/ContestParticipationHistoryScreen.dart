import 'package:MediaPlus/MODULES/ContestingModule/ContestParticipationModule/controllers/ContestParticipationHistoryScreenController.dart';
import 'package:MediaPlus/MODULES/ContestingModule/ContestParticipationModule/views/ContestParticipationPostUploadScreen.dart';
        ...
        builder: (controller) => Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  TextButton(
                      onPressed: () {
                        Get.to(() => ContestParticipationPostUploadScreen(contestId: "dfdf",contestName: "dfsdfdf",));
                      },
                      child: Text("post"))
                ],
              ),
