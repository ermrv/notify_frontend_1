...
import 'package:MediaPlus/MODULES/AddPostModule/controllers/ImagesGridDisplayController.dart';
                ...
                title: controller.albums.length == 0
                    ...
                    : DropdownButton(
                        hint: Container(
                            ...
                            child: Text(controller.value.toString(),overflow: TextOverflow.ellipsis,)),
