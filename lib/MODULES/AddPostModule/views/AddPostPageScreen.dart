...
import 'package:MediaPlus/MODULES/AddPostModule/controllers/AddPostPageController.dart';
              ...
              children: [
                ...
                controller.videoFile == null
                    ...
                    : Stack(
                      ...
                      controller.compressedImages==null?Container():Column(
                        children: [
                          for(Uint8List i in controller.compressedImages)Image.memory(i)
                        ],
                      )
              ],
            ),
