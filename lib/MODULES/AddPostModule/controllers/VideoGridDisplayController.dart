...
import 'package:MediaPlus/MODULES/AddPostModule/views/VideoPreviewPageScreen.dart';
...
class VideoGridDisplayController extends GetxController {
  ...
  handleOnTap(AssetEntity element) async {
    ...
    Map<String, dynamic> videoFileData = await Get.to(() =>
        VideoPreviewPageScreen(videoFile: file, aspectRatio: aspectRatio,thumbData: thumbData,));
