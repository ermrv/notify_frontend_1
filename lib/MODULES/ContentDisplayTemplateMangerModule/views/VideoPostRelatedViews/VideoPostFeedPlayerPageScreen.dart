import 'package:MediaPlus/MODULES/ContentDisplayTemplateMangerModule/views/VideoPostRelatedViews/FullVideoPostPlayerTemplate.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
              child: Column(
          children: [
            for (var i in videos) FullVideoPostPlayerTemplate(postContent: i,id: "4",),
