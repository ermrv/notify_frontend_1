...
class UserFollowersList extends StatefulWidget {
  ...
  @override
  _UserFollowersListState createState() => _UserFollowersListState();
}
...
class _UserFollowersListState extends State<UserFollowersList> {
  ...
  _getData() async {
    var response = await ApiServices.postWithAuth(ApiUrlsData.userFollowers,
        {"userId": widget.userId}, userToken.toString());
    if (response == "error") {
